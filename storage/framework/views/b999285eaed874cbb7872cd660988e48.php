 ...
 <header id="header" class="fixed-top d-flex align-items-center">
        ...
        <ul>
          ...
          <li class="dropdown"><a href="#"><span>Jenis Pelayanan</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              ...
              <li class="dropdown"><a href="/ranap"><span>Unit Rawat Inap</span> <i class="bi bi-chevron-right"></i></a>
                <ul>
                  ...
                  <li><a href="/hcu_icu">HCU/ICU</a></li>
                </ul>
              </li> 
          ...
          <li class="dropdown"><a href="">Tarif</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
                <li><a href="/tarif_kamar">Kamar</a></li>
                <li><a href="/tarif_penunjang">Penunjang</a></li>
            </ul>
        </li>
  ...
  </header><!-- End Header --><?php /**PATH D:\@rsih-website\rsih-website\resources\views/layouts/header.blade.php ENDPATH**/ ?>