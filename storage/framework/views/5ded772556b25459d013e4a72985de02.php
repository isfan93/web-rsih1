            ...
            <table class="table stripped table-sm table-hover mt-2">
                ...
                <tbody>
                    <tr>
                        ...
                        <td style="font-weight: bold"><?php echo e($jd->senin); ?></td>
                        <td style="font-weight: bold"><?php echo e($jd->selasa); ?></td>
                        <td style="font-weight: bold"><?php echo e($jd->rabu); ?></td>
                        <td style="font-weight: bold"><?php echo e($jd->kamis); ?></td>
                        <td style="font-weight: bold"><?php echo e($jd->jumat); ?></td>
                        <td style="font-weight: bold"><?php echo e($jd->sabtu); ?></td>
                        <td style="font-weight: bold"><?php echo e($jd->minggu); ?></td>
                                ...
                                <div class="modal-body">
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            ...
                                            <label>Senin : <span style="font-weight: bold"><?php echo e($jd->senin); ?></span></label><br>
                                            <label>Selasa : <span style="font-weight: bold"><?php echo e($jd->selasa); ?></span></label><br>
                                            <label>Rabu : <span style="font-weight: bold"><?php echo e($jd->rabu); ?></span></label><br>
                                            <label>Kamis : <span style="font-weight: bold"><?php echo e($jd->kamis); ?></span></label><br>
                                            <label>Jumat : <span style="font-weight: bold"><?php echo e($jd->jumat); ?></span></label><br>
                                            <label>Sabtu : <span style="font-weight: bold"><?php echo e($jd->sabtu); ?></span></label><br>
                                            <label>Minggu : <span style="font-weight: bold"><?php echo e($jd->minggu); ?></span></label><br>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\@rsih-website\rsih-website1\resources\views/rajal-dokter.blade.php ENDPATH**/ ?>