...
<!--===============================================================================================-->
	<link rel="stylesheet" type="text/css" href="assets/vendor-mainte/bootstrap/css/bootstrap.min.css">
<!--===============================================================================================-->
...
<body>
	...
	<div class=" size1 flex-w flex-col-c-sb p-l-15 p-r-15 p-b-30">
		...
		<div class="flex-col-c w-full p-t-50 p-b-80" >
			...
			<p class="txt-center l1-txt2 p-b-43 wsize2" style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif">
				Website Kami sedang dalam perbaikan, follow akun official kami untuk info lebih lanjut, Terimakasih
			</p>
			...
			<!-- Facebook -->
			<a class="social-media-icon facebook" href="https://www.facebook.com/profile.php?id=100016267926190&ref=br_rs">
				<span class="fab fa-facebook"></span>
			</a>
			
			<!-- Ytb -->
			
			<a class="social-media-icon youtube" href="https://www.youtube.com/@RumahSakitIntanHusada">
				<span class="fab fa-youtube"></span></a>
			<!-- Instagram -->
			<a class="social-media-icon instagram" href="https://www.instagram.com/rs_intanhusada/">
